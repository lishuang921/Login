...
public class HomeAdapter extends RecyclerView.Adapter {
    ...
    public void setBanner(List<Banners> banners){
        mBannerList = banners;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        try {
            Constructor<? extends RecyclerView.ViewHolder> constructor =  aClass.getConstructor(HomeAdapter.class,View.class);
    ...
    private class BannerHolder extends RecyclerView.ViewHolder{
        ...
        private void setData(List<Banners> banners){
            ...
            mJBanner.setAdapter(new JBannerAdapter<Banners>() {
                @Override
                public void fillBannerItemData(JBanner banner, ImageView imageView, Banners mode, int position) {
