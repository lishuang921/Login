...
public class JBanner extends ConstraintLayout {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxTitleSize = SystemFacade.dp2px(getContext(), 20);
        ...
        //默认 20dp
        mTitleSize = (int) typedArray.getDimension(R.styleable.JBanner_titleSize, SystemFacade.dp2px(getContext(), 20));
        // 默认白色
        mTitleColor = typedArray.getColor(R.styleable.JBanner_titleColor, Color.WHITE);
        // 默认 5dp
        mIndicatorRadius = (int) typedArray.getDimension(R.styleable.JBanner_indicatorRadius, SystemFacade.dp2px(getContext(), 5));
    ...
    public void setAdapter(JBannerAdapter adapter) {
        mAdapter = adapter;
    ...
    private Runnable mLooper = new Runnable() {
        ...
        public void run() {
            ...
            mViewPager.setCurrentItem(++currentItem); // 每次切换一页page
    ...
    private void initView() {
        ...
        constraintSet.connect(mIndicator.getId(), ConstraintSet.RIGHT, ConstraintSet.PARENT_ID, ConstraintSet.RIGHT, SystemFacade.dp2px(getContext(), 16));
        ...
        constraintSet.connect(mTvTitle.getId(), ConstraintSet.LEFT, ConstraintSet.PARENT_ID, ConstraintSet.LEFT, SystemFacade.dp2px(getContext(), 16));
